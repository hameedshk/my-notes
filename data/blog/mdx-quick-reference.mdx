...
| Image with caption |  `<figure>    <img src="/static/images/blogs/gen-ai.png" alt="Gen AI image"/> <figcaption>Gen AI Input and Output. </figcaption> </figure>` | <figure>    <img src="/static/images/blogs/gen-ai.png" alt="Gen AI image"/> <figcaption>Gen AI Input and Output. </figcaption> </figure> 
...
| Color | This is red `#RRGGBB` in color                               | This is red `#RRGGBB` in color
| Color - HTML way| `This is <span style="color:red">red</span> in color`                               | This is  in color
