...
date: '2022-12-12'
tags: ['gen-ai', 'ai', 'artificial', 'intelligence']
summary: 'Basics of generative AI'
images:
  [
...
![Gen AI](/static/images/blogs/gen-ai-def.png)

Conventional AI, also known as "narrow AI," refers to AI systems that are designed and trained to perform specific tasks.
- Recomendation systems like Netflix uses AI to suggest movies and TV shows based on a user's viewing history.
...
![Gen AI](/static/images/blogs/gen-ai.png)

`Artificial Intelligence ` - Everything that we(human) do, whether it is science or arts or sports, human brain is the most intelligent thing on this Earth. Now, this is real intelligence. When we intend to replicate this intelligence into a machine i.e we are trying to make a machine as smart as intelligent as a human being, that is called as artificial intelligence or AI.
So, artificial intelligence is the development of machines that can perform task that typically require human intelligence? For example, you can create Medical systems that can diagnose diseases from X-ray Or they can predict property prices, or they can even detect credit card frauds.
All of these are things that humans have done with their typical intelligence but we can have machines to the same and that's what artificial intelligence or AI is.

![Gen AI](/static/images/blogs/ai-timeline.png)
...
The `srcset` and `sizes` values look a bit complicated (and easy to forget they are not that hard to understand.
