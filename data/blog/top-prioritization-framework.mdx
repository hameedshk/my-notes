...
![Value vs effort diagram](/my-notes/static/images/blogs/value-vs-effort.png "Value vs Effort 2D graph")
...
![moscow application simple example](/my-notes/static/images/blogs/moscow.png "moscow breakdown")
...
![RICE prioritization example](/my-notes/static/images/blogs/rice-prioritization.png "RICE Model example")
...
_Examples: Faster load times on a website, better battery life on a smartphone._
...
__Examples: A free add-on service, surprise discounts, or innovative design features.__
...
_Examples: Features that are nice to have but do not influence the customer’s purchase decision._
...
_Examples: A highly customizable interface might be appreciated by power users but confusing for average users._
