...
I have recently graduated and have accumulated over a year of specialized experience in the development and product management. Currently, I am working as a Product Owner at Airbus. Besides, product management, I build appications using Microsoft technologies dotnet , SQL and JavaScript technologies including NodeJS, TypeScript, Next.js.

As for my career goals, I am learning about programming and product management. I’m willing to work hard to achieve this goal.
...
- [Simulating Basic Geometry](https://github.com/hameed/Project_Computer-Graphics): Simulating basic geometry using ThreeJS, Vanilla JavaScript and jQuery.
- [Website Selling Food](https://github.com/ZiDuck/Website-Selling-Food): Final project of web application development.
- [Pokemon Shopping Cart](https://github.com/hameed/Shopping-Cart): Learn Typescript from scratch.
